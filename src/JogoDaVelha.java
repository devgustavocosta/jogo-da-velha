...
public class JogoDaVelha extends JFrame {
    ...
    JButton zerar = new JButton("Recomeçar");
    int PX = 0;
    int PO = 0;
    boolean xo = false;
    ...
    public JogoDaVelha(){
        ...
        px.setFont(new Font("Arial", Font.BOLD, 14));
        po.setFont(new Font("Arial", Font.BOLD, 14));
    ...
    public void ganhou(){
        ...
        if ((bt[0].getText() == "X" && bt[1].getText() == "X" && bt[2].getText() == "X")
            ...
            JOptionPane.showMessageDialog(null, "Parabéns! X ganhou.");
            PX ++;
            atualizar();
            limpar();
            ...
            JOptionPane.showMessageDialog(null, "Parabéns! O ganhou.");
            PO ++;
            atualizar();
            limpar();
        } else if(cont == 9){
